    ...
    <>
      ...
      >
        <div className="overflow-hidden grid grid-cols-1 lg:grid-cols-2 rounded-[24px]">
          <div
            className="flex flex-col items-center md:items-start px-8 md:px-12 lg:px-16 py-12 md:py-16 lg:py-20 bg-amber-200
              selection:bg-green-100 selection:text-amber-900"
          >
            <div
              className="select-none flex justify-center items-center gap-2 w-fit mb-7
                border border-green-700 rounded-full px-6 py-3 bg-transparent"
            >
              <span className="w-4 h-px bg-green-700" />

              <span
                className="tracking-[12%] text-[11px] uppercase font-semibold
                  text-green-700"
              >
                Get started
              </span>
            ...
            <h2
              id="cta-heading"
              className="max-w-lg mb-5 text-center md:text-start leading-[1.24]
                tracking-[-2%] text-[34px] md:text-[40px] lg:text-[44px] font-semibold
                text-grey-600"
            >
            ...
            <p
              className="max-w-lg mb-5 text-center md:text-start leading-[1.7]
                lg:text-[16.5px] text-grey-700"
            >
            ...
            <p className="mt-5 text-center md:text-start text-[13.5px] text-grey-600">
              Or email us directly at{" "}
              <Link
                href="mailto:hello@isoleap.com"
                className="font-medium text-green-700 underline underline-offset-2
                  decoration-green-700/30 transition-colors duration-150
                  hover:text-green-800 hover:decoration-green-800/50"
              >
                hello@isoleap.com
              </Link>
            </p>
